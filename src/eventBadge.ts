import { ipfs, JSONValue, JSONValueKind, log } from "@graphprotocol/graph-ts";
...
export function handleCreateEventSession(event: createdEventSession): void {
    ...
    if (eventObj != null) {
        ...
        eventBadgeObj.contentUri = event.params.session.contentUri;
        ...
        log.info("[info]Created Event Badges | id: {}", [eventBadgeObj.id]);
    }
}
